...
import { FILES_INPUT_ACCEPT } from '../../../config/fileTypes';
...
const InventoryFormFields = ({
  ...
  return (
    <GlobalDropZone imagesField="images" filesField="files">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 space-y-6">
          {/* Images Section */}
          <FormSection title="Imágenes" icon={Image} variant="card">
            <Field name="images" id="images" component={ImagePicker} multiple />
          </FormSection>

          {/* Files Section */}
          <FormSection title="Archivos" icon={Paperclip} variant="card">
            <Field
              name="files"
              id="files"
              component={FileInput}
              multiple
              helperText="PDF, Word, Excel, RAR, ZIP, Video y más"
              accept={FILES_INPUT_ACCEPT}
            />
          </FormSection>
        </div>
      </div>
