                      ...
                      >
                        ...
                        <div className="flex items-center justify-end">
                          <button
                            onClick={() =>
                              isAssigned
                                ? handleUnassign(assignmentId, inventory.id)
                                : handleAssign(inventory.id)
                            }
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-end mt-2">
                <button
                  onClick={() => handleUnassign(assignmentId, inventory.id)}
            ...
            tabs={[
              {
                title: 'Asignados',
                icon: BsBoxSeam,
                content: <AssignedInventoriesTab />,
              },
              {
                title: 'Buscar y Asignar',
                icon: FaPlus,
                content: <SearchAndAssignTab />,
              },
            ]}
          />
        </DialogPanel>
